...
class PID_Controller final
{
 ...
 public:
  ...
  struct B_PID_Controller_T {
    ...
    real_T FilterCoefficient_fo;       // '<S155>/Filter Coefficient'
    real_T st_idx_0;
    real_T st_idx_1;
  };
  ...
  struct DW_PID_Controller_T {
    ...
    real_T Integrator_DSTATE_m;        // '<S46>/Integrator'
    real_T Filter_DSTATE_e;            // '<S41>/Filter'
    real_T Integrator_DSTATE_f;        // '<S100>/Integrator'
    real_T Filter_DSTATE_en;           // '<S95>/Filter'
    real_T Integrator_DSTATE_k;        // '<S152>/Integrator'
    real_T Filter_DSTATE_n;            // '<S147>/Filter'
  };
...
//  '<S3>'   : 'PID_Controller/Controller1/MATLAB Function'
