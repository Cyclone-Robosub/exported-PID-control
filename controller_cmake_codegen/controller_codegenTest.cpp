...
// C/C++ source code generated on : Tue May 13 21:09:51 2025
//
...
void controller_codegenTest::step()
{
  ...
  rtDW.Integrator_DSTATE[0] += rtU.Input[0] * rtb_xyz_idx_1 * 0.1;
  ...
  rtDW.Integrator_DSTATE[1] += rtU.Input[1] * rtb_xyz_idx_1 * 0.1;
  ...
  rtDW.Integrator_DSTATE[2] += rtU.Input[2] * rtb_xyz_idx_1 * 0.1;
  ...
  rtDW.Integrator_DSTATE_k += 2.325 * rtU.Input[3] * 0.1;
  ...
  rtDW.Integrator_DSTATE_o += 3.236 * rtU.Input[4] * 0.1;
  ...
  rtDW.Integrator_DSTATE_a += roll_flag * rtb_yaw_idx_1 * 0.1;
  for (i = 0; i < 8; i++) {
